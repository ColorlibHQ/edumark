...
// image default alt
if( !function_exists( 'edumark_img_default_alt' ) ){
	function edumark_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'edumark_img_tag' ) ){
	function edumark_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = edumark_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'edumark_anchor_tag' ) ){
	function edumark_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'edumark_heading_tag' ) ){
	function edumark_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'edumark_paragraph_tag' ) ){
	function edumark_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'edumark_other_tag' ) ){
	function edumark_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'edumark_button_element ' ) ){
	function edumark_button_element( array $args ){

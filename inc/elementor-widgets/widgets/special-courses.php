 ...
 * @since 1.0
 */
class Edumark_Special_Courses extends Widget_Base {

	public function get_name() {
		return 'edumark-special-courses';
	}

	public function get_title() {
		return __( 'Special Courses', 'edumark' );
	}
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            'sec_heading',
            [
                'label'         => esc_html__( 'Heading Text', 'edumark' ),
                'type'          => Controls_Manager::WYSIWYG,
                'default'       => __( '<p>popular courses</p><h2>Special Courses</h2>', 'edumark' )
            ]
        );
        ...
        $this->start_controls_section(
            'menu_tab_sec',
            [
                'label' => __( 'Courses', 'edumark' ),
            ]
        );
        $this->add_control(
			'course_order',
			[
				'label'         => esc_html__( 'Course Order', 'edumark' ),
		...
		$this->add_control(
			'excerpt_limit', [
				'label'         => esc_html__( 'Excerpt Limit', 'edumark' ),
		...
		$this->add_control(
			'course_item', [
				'label'         => esc_html__( 'Course Item', 'edumark' ),
				'type'          => Controls_Manager::NUMBER,
				'max'           => 6,
				'min'           => 1,
				'step'          => 1,
        ...
        $this->start_controls_section(
            'color_settings', [
                'label' => __( 'Color Settings', 'edumark' ),
        ...
        $this->add_control(
            'big_title_trainer_name_color', [
                'label'     => __( 'Big & Course Title & Trainer Name Color', 'edumark' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#0c2e60',
                'selectors' => [
        ...
        $this->add_control(
            'course_cat_fee_bg_color', [
                'label'     => __( 'Course Cat BG & Fee Color', 'edumark' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#ff663b',
                'selectors' => [
        ...
        $this->add_control(
            'course_text_color', [
                'label'     => __( 'Other Text Color', 'edumark' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#888',
                'selectors' => [
    ...
    <section class="special_cource padding_top">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <?php
                    edumark_special_courses( $cNumber, $cOrder, $excerpt_limit );
                ?>
            </div>
        </div>
    </div>

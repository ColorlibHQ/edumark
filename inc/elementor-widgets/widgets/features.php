 ...
 * @since 1.0
 */
class Edumark_Features extends Widget_Base {

	public function get_name() {
		return 'edumark-features';
	}

	public function get_title() {
		return __( 'Features', 'edumark' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'features_heading',
            [
                'label' => __( 'Features Heading', 'edumark' ),
            ]
        );
        $this->add_control(
            'feature_header',
            [
                'label'         => esc_html__( 'Feature Header', 'edumark' ),
                'description'   => esc_html__('Use <br> tag for line break', 'edumark'),
                'type'          => Controls_Manager::WYSIWYG,
                'label_block'   => true,
                'default'       => __( '<h2>Awesome <br> Feature</h2><p>Set have great you male grass yielding an yielding first their you\'re have called the abundantly fruit were man </p>', 'edumark' )
            ]
        );
        $this->add_control(
            'btn_lbl',
		...
		$this->start_controls_section(
			'features_block',
			[
				'label' => __( 'Features', 'edumark' ),
			]
		);
		$this->add_control(
            'features_content', [
                'label' => __( 'Create Feature', 'edumark' ),
                ...
                'fields' => [
                    ...
                    [
                        'name'  => 'label',
                        'label' => __( 'Title', 'edumark' ),
                        'type'  => Controls_Manager::TEXT,
                        'label_block' => true,
                        'default' => __( 'Better Future', 'edumark' )
                    ],
                    [
                        'name'      => 'desc',
                        'label'     => __( 'Descriptions', 'edumark' ),
                        'type'      => Controls_Manager::TEXTAREA,
                        'default'   => __( 'Set have great you male grasses yielding yielding first their to called deep abundantly Set have great you male', 'edumark' )
                    ],
                ],
            ]
        );
        ...
        $this->start_controls_section(
            'btn_bg_color_sec', [
                'label' => __( 'Button BG Color Style', 'edumark' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_group_control(
            ...
            [
                'name' => 'btn_bg_color',
                'label' => __( 'Button BG Color', 'edumark' ),
                'types' => [ 'gradient' ],
        ...
        $this->start_controls_section(
            'single_serv_color_sett', [
                'label' => __( 'Single Feature Color Settings', 'edumark' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'item_hover_border_color', [
                'label'     => __( 'Item Hover Border Color', 'edumark' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#ff663b',
                'selectors' => [
        ...
        $this->add_control(
            'item_hover_icon_color', [
                'label'     => __( 'Item Hover Icon Color', 'edumark' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fff',
                'selectors' => [
        ...
        $this->start_controls_section(
            'item_hover_icon_style_sec', [
                'label' => __( 'Item Hover Icon BG Color', 'edumark' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_group_control(

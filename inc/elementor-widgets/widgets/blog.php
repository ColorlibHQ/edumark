...
/**
 *
 * Edumark elementor few words section widget.
 *
 * @since 1.0
 */
...
class Edumark_Blog extends Widget_Base {
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'blog_content',
            [
                'label' => __( 'Latest Blog Post', 'edumark' ),
            ]
        );
		$this->add_control(
			'sec_title',
			[
				'label'         => esc_html__( 'Title', 'edumark' ),
				'description'   => __( "Use < span> tag for color and italic word", "edumark" ),
				'type'          => Controls_Manager::WYSIWYG,
				'label_block'   => true,
				'default'       => __( '<p>Our Blog</p><h2>Students Blog</h2>', 'edumark' )
			]
		);
        ...
        $this->start_controls_section(
            'blog_post_sec',
            [
                'label' => __( 'Blog Post Settings', 'edumark' ),
            ]
        );
		$this->add_control(
			'post_num',
			[
				'label'         => esc_html__( 'Post Item', 'edumark' ),
		...
		$this->add_control(
			'post_exc',
			[
				'label'         => esc_html__( 'Post Excerpt Length', 'edumark' ),
				'type'          => Controls_Manager::NUMBER,
				'label_block'   => false,
                'default'       => absint(13),
                'min'           => 5,
		...
		$this->add_control(
			'post_order',
			[
				'label'         => esc_html__( 'Post Order', 'edumark' ),
        ...
        $this->add_control(
            'color_big_title', [
                'label'     => __( 'Big Title Color', 'edumark' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#0c2e60',
                'selectors' => [
        ...
        $this->add_control(
            'section_separator',
            [
                'label'     => __( 'Category BG Styles', 'edumark' ),
        ...
        $this->add_control(
            'cat_bg_col', [
                'label'     => __( 'Category BG Color', 'edumark' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#ff663b',
                'selectors' => [

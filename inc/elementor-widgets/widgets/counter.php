 ...
 * @since 1.0
 */
class Edumark_Counter extends Widget_Base {

	public function get_name() {
		return 'edumark-counter';
	}

	public function get_title() {
		return __( 'Counter', 'edumark' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Counter Setting', 'edumark' ),
			]
		);
		...
		$this->add_control(
            'counter_contents', [
                ...
                'fields' => [
                    [
                        'name'  => 'count_val',
                        'label' => __( 'Counter Value', 'edumark' ),
                    ...
                    [
                        'name'  => 'count_lbl',
                        'label' => __( 'Counter Label', 'edumark' ),
        ...
        $this->add_control(
            'counter_color', [
                'label'     => __( 'Counter Text Color', 'edumark' ),

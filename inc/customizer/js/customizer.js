(function( $ , api){
    ...
    api.section( 'edumark_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'edumark_about_section' , function( section ){
    ...
    api.section( 'edumark_blog_section' , function( section ){
    ...
    api.section( 'edumark_course_section' , function( section ){
    ...
    api.section( 'edumark_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-edumark_contact_custom_formshortcode'),
                selector = $('#_customize-input-edumark_contact_formshortcode');
    ...
    // General section
    api.section( 'edumark_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#edumark_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-edumark_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-edumark_preloader_color' );
            ...
            var $backtotop          = $( '#edumark_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-edumark_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-edumark_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'edumark_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle             = $('#edumark_footer_widget_toggle');
            var $footer_bg_color           = $('#customize-control-edumark_footer_bg_color');
            var $footer_txt_color          = $('#customize-control-edumark_footer_widget_text_color');
            var $footer_title_color        = $('#customize-control-edumark_footer_widget_title_color');
            var $footer_anc_color          = $('#customize-control-edumark_footer_widget_anchor_color');
            var $footer_anc_hover_color    = $('#customize-control-edumark_footer_widget_anchor_hover_color');

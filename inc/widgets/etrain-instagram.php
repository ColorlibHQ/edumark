...
class edumark_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('edumark_instagram_photo',esc_html__('[ Edumark ] Intagram Photo','edumark'),array(
			'description' => esc_html__('Edumark Instagram Photo Widget','edumark'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'edumark');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'edumark'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'edumark'); ?></label>
